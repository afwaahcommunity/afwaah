...
export const Route = createFileRoute("/me")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Edit your anonymous display name and color." },
    ],
  }),
  component: Me,
});
...
function Me() {
  ...
  if (!session) return <AppShell><div className="h-20 animate-pulse rounded-lg bg-muted" /></AppShell>;
  ...
  return (
    <AppShell maxWidth="max-w-xl">
      ...
      <p className="mt-0.5 text-xs text-muted-foreground">Your identity is anonymous and only used inside campus chat.</p>
        ...
        <section className="rounded-lg border border-border bg-card p-5">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Session {session.token.slice(0, 10)}…</div>
            </div>
          </div>
